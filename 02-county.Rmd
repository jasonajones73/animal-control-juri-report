...
## Monthly call volume {#countyvolume}

How many calls do we receive each month?

```{r}
call_data %>%
  filter(jurisdiction == "Guilford County") %>%
  ...
  geom_text(aes(label = scales::comma(total)), color = "white", nudge_y = -20) +
  scale_y_continuous(labels = scales::comma_format())
```

## Nature Breakdown {#countynatures}
...
## Location Overview {#countylocation}
